...
fun displayProduct(navController: NavController,vm:Model){
    Column {
        Button(onClick = {                     navigateTo(navController, DestinationScreen.Add.route)
        }) {
...
fun ProductItem(product: ProductData, vm: Model) {
    ...
    Box(modifier = Modifier
        .fillMaxWidth()
        .padding(15.dp)
        .border(BorderStroke(1.dp, Color(0xFF2196f3)), shape = RoundedCornerShape(5.dp)).padding(10.dp)
